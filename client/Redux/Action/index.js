...
export const getAllClients = (id) => {
	return async (dispatch) => {
		let response = await axios.get(
			`https://fixy-backend.herokuapp.com/client?id=${id}`
		);
		return dispatch({
...
export const getRequestDetail = (id) => {
	return async (dispatch) => {
		const info = await axios.get(
			`https://fixy-backend.herokuapp.com/request?id=${id}`
		);
		return dispatch({
...
export const createBudget = (payload) => {
	return async (dispatch) => {
		const info = await axios.post(
			`https://fixy-backend.herokuapp.com/budget`,
			payload
		);
		return dispatch({
			type: CREATE_BUDGET,
...
export const getBudgetDetail = (id) => {
	return async (dispatch) => {
		try {
			let response = await axios.get(
				`https://fixy-backend.herokuapp.com/budget/${id}`
			);
			return dispatch({
...
export const userDetail = (id, user) => {
	return async (dispatch) => {
		let response = await axios.get(
			`https://fixy-backend.herokuapp.com/${user}/${id}`
		);
		return dispatch({
			type: USER_DETAIL,
			payload: response.data,
...
export const setStatusRequestToActive = (id) => {
	return async (dispatch) => {
		let response = await axios.put(
			`https://fixy-backend.herokuapp.com/request/${id}`
		);
	};
};
