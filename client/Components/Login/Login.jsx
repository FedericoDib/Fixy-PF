...
const Login = () => {
	...
	const [request, response, promptAsync] = isLogged? null : Google.useAuthRequest({
		expoClientId:'302940809798-bb9fvtjipv232sglpnrglc228fp28r1q.apps.googleusercontent.com',
	});
